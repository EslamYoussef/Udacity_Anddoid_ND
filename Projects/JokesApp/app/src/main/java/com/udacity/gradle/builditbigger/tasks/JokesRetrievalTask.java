...
public class JokesRetrievalTask extends AsyncTask<Void, Void, String> {
    private static MyApi myApiService = null;
    private Context context;
    private JokeListener mJokesListener;

    public JokesRetrievalTask(JokeListener jokesListener) {
